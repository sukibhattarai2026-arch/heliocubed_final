...
Out_file = "psi_eclipse24_swig_wsa2_smth5_bc_r21_5_corotating_Bp_all_frames.h5"
step_const = [0, 1, 0]
phi_face = True
time_cadence = 1.0/24.
...
# Go one directory back, enter boundary_data, and append your file name
Out_file = os.path.join(current_directory, "..", "boundary_data", Out_file)
